...
(function() {
  var Builder, CoffeeScriptError, EventEmitter, TypeScriptError, async, fs, go, path, spawn, suspend, writestreamp,
  ...
  Builder = (function(_super) {
    ...
    Builder.prototype.build = suspend.async(function*() {
      ...
      this.proc = spawn("" + __dirname + "/../../bin/dts-merger", ['--output', "../dist"].include(this.tsFiles()), {
